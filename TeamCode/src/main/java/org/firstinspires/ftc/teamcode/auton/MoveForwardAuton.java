...
@Autonomous(name="MOVE FORWARD - Auton", group="Autonomous")
...
public class MoveForwardAuton extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public PathChain MoveForward;

        private Pose startPose = new Pose(56.000, 8.000, Math.toRadians(180));
        private PresetPoses poses = new PresetPoses(startPose, false);


        public Paths(Follower follower) {
            MoveForward = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(poses.startPose, new Pose(30,8))
                    )
