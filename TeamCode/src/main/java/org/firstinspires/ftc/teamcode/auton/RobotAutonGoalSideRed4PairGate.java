...
@Autonomous(name="GOAL SIDE RED - 4Pair Gate Auton", group="Autonomous", preselectTeleOp = "SELECTABLE - PedroPathingTeleOp")
@Configurable // for Panels
@SuppressWarnings("FieldCanBeLocal") // android studio bugging
public class RobotAutonGoalSideRed4PairGate extends OpMode {
