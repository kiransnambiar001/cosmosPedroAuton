...
//
//
//@Autonomous(name="FAR SIDE BLUE - 3 Pair Auton", group="Autonomous")
//@Configurable // for Panels
//@SuppressWarnings("FieldCanBeLocal") // android studio bugging
//public class RobotAutonFarBlue3Pair extends LinearOpMode {
//
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(poses.farShootPose, poses.hpStartPose)
//                    )
//                    .setLinearHeadingInterpolation(poses.farStartPose.getHeading(), poses.hpStartPose.getHeading())
//                    .build();
//
//            PickupHP = follower
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(poses.hpStartPose, poses.hpEndPose)
//                    )
//                    .setTangentHeadingInterpolation()
//                    .build();
//
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(poses.hpEndPose, poses.farShootPose)
//                    )
//                    .setLinearHeadingInterpolation(poses.hpEndPose.getHeading(), poses.farShootPose.getHeading())
//                    .build();
//
//            Park = follower
//                    .pathBuilder()
...
//            case 4:
//                if (!follower.isBusy()) {
//                    follower.followPath(paths.GotoHP);
//                    pathState = 5;
//                }
//                break;
//
//            case 5:
//                if (!follower.isBusy()) {
//                    follower.followPath(paths.PickupHP, 0.3, true);
//                    gate.setGateState(true);
//                    intake.run(1);
//                    pathState = 6;
//                }
...
//                    }
//                    else if (shooting) {
//                        if ((hardware.timer.milliseconds() >= previousTime + 5500)) {
//                            gate.setGateState(true);
